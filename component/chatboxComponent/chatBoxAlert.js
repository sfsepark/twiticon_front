export default (props) => {
    return  (
        <div className = {'chatbox-chat-log ' + (props.logToggle ? '' : 'chatbox-chat-log-off')}>
            ...
            <line id="선_15" data-name="선 15" x2="11" y2="11" transform="translate(524.5 908.5)" fill="none" stroke="#777777" stroke-width="4"/>
            <line id="선_16" data-name="선 16" y1="11" x2="11" transform="translate(524.5 908.5)" fill="none" stroke="#777777" stroke-width="4"/>
            </g>
            </svg>
