            ...
            <div className = {'mobile-nav-bar ' 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="25.044" height="29.356" viewBox="0 0 25.044 29.356">
                    <g id="icon_search" transform="translate(1.5 1.5)">
                        <path id="패스_1551" data-name="패스 1551" d="M0,0,5.554,6.518" transform="translate(16.848 20.366)" fill="none" stroke="#b9b9b9" strokeWidth="3"/>
                        <ellipse id="타원_1" data-name="타원 1" cx="10.497" cy="10.799" rx="10.497" ry="10.799" transform="translate(0 0)" fill="none" stroke="#4e4e4e" strokeMiterlimit="10" strokeWidth="3"/>
                    </g>
                </svg>
                </div>
                {
